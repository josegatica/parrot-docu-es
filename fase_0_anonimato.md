...
> Importante: la línea de resolución de dns debe estar descomentada, para asegurarnos de que la resolución de DNS se haga a través de los servidores proxy.
